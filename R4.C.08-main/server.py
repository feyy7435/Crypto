...
class Server:
    ...
    def generate_private_key(self):
        # Read the passphrase from the file input/test.txt
        with open("input/test.txt", "r") as passfile:
            private_key_pass = passfile.read().strip()  # Read and remove any extra whitespace
        ...
        private_key_file = open("input/private_key_rsa.txt", "w")
